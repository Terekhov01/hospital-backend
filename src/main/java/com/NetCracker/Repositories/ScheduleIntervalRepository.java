...
@Repository
public interface ScheduleIntervalRepository extends JpaRepository<ScheduleInterval, ScheduleIntervalId>//, CustomIntervalRepository
{
    ...
    ScheduleInterval findByDoctorAndTime(@Param("id") Long id, @Param("time") LocalDateTime time);
}
