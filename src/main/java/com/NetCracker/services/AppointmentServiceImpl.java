...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Override
    @Transactional
    public void createAppointment(AppointmentCreationDTO appointmentDTO, List<MultipartFile>filesToUpload, AppointmentRegistration appointmentRegistration) throws DataAccessException, IOException
    {
