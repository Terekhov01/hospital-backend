...
public interface AppointmentService {
    ...
    void createAppointment(AppointmentCreationDTO appointmentDTO, List<MultipartFile> filesToUpload, AppointmentRegistration appointmentRegistration) throws DataAccessException, IOException;
}
